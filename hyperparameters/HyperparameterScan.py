...
os.mkdir(result_dir)
filename = f'datasets/fuchs_v5_0_seed-2_train_1525000_noise_10_threeEns_.h5'
test_filename = f'datasets/fuchs_v5_0_seed-2_test_250000_noise_0_{identifier}_.h5'
df = pd.read_hdf(filename, key='df')
test_df = pd.read_hdf(test_filename, key='df')
datype = np.float32
num_inputs = 4
...
param_grid = {
    ...
    'optimizer__lr':[1e-1, 1e-2, 1e-3, 1e-4],
    'callbacks__lr_scheduler__gamma':[0.99, 0.95, 0.9, 0.85],
...
grid_result_df.to_csv(result_dir + 'grid_search_results.csv', index=False)